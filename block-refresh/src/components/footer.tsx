...
export const Footer = () => {
  return (
    <footer className="bg-[#cce3de] dark:bg-[#475c54] pt-4 pb-6 xl:pt-8 bottom-[0] w-[100%]">
        ...
        <ul className="flex flex-wrap justify-center pb-4 text-lg font-light">
          <li className="w-1/2 md:w-1/3 lg:w-1/3">
            <div className="text-center">
              <h2 className="text-[#475c54] dark:text-[#bee4db] text-md uppercase mb-3">
                Block Refresh
              </h2>
              <ul>
                <li className="mb-2 text-sm text-[#475c54] dark:text-[#cce3de]">
                  All Rights Reserved
                </li>
                <li className="mb-2 text-sm text-[#475c54] dark:text-[#cce3de]">
                  ©2023 Block Refresh
          ...
          <li className="w-1/2 md:w-1/3 lg:w-1/3">
            <div className="text-center">
              ...
              <ul>
                <li className="mb-2 transition-colors text-base duration-200 hover:text-[#475c54] dark:hover:text-[#cce3de]">
                  <a href="#">Home</a>
                </li>
                <li className="mb-2 transition-colors text-base duration-200 hover:text-[#475c54] dark:hover:text-[#cce3de]">
                  <a href="#">About Us</a>
